...
|스터디|날짜|장소|진행자|내용|
|:---:|:---:|:---:|:---:|:---:|
|Part1 1주차 복습 스터디|2019년 10월 4일|310관 731호|`예진`<br>`소현`|#HTML #태그 #class #id #선택자 #크롬_검사|
|Part1 2주차 복습 스터디|2019년 10월 11일|중앙도서관 3층 스터디룸1|`주형`<br>`혜지`|#파이썬_문법 #변수 #자료형 #입출력 #문자열 #리스트 #for문|
...
|Part1 4주차 복습 스터디|2019년 11월 1일|310관 731호|`종수`<br>`정빈`|#가공된_데이터를_csv로 #가공된_데이터를_xlsx로|
